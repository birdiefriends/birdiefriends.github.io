...
4a. **"Do the work once, get paid a lot" — lifetime attribution, not residual.** An Ambassador is permanently credited as the originator of any player they bring into the BF ecosystem. The mechanic (settled BP-3): a one-time 20% origination commission on that player's first booking, plus a 5% recurring override on the player's future bookings — but the recurring override is **conditioned on the Ambassador remaining active** (illustrative bar: averaging roughly one new group brought in per month), not paid unconditionally forever. This keeps the "build your own ATM" incentive — sustained effort is sustained income — while making the liability self-limiting by construction: an inactive Ambassador's override simply stops. Founder's framing: "do the work once, get paid a lot" still holds for the one-time piece; the recurring piece rewards continued contribution, not a single act in perpetuity. **Open question (carried to Gate 4):** whether 5% recurring is large enough at realistic volume to function as a meaningful incentive, or too small to matter — not yet modeled at scale.
...
**Ambassador, never entrepreneur/operator.** The word choice carries the community-advocate framing intentionally. Don't drift back to franchise/operator language in plan documents — it changes the psychology of the entire model.
...
- Not a subscription-first business (Layer 3 / day-to-day BF subscription is a future option, not a launch dependency — founder has explicitly low confidence in golfer willingness to pay recurring fees)
